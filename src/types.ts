...
export type TcbBoardPosition = { [square in TcbSquare]?: TcbPiece };

export type TcbPromotionPieceOption =
  | 'wQ'
  | 'wR'
  | 'wN'
  | 'wB'
  ...
  | 'bN'
  | 'bB';
export type TcbPromotionStyle = 'default' | 'vertical' | 'modal';

export type TcbCustomSquareProps = {
  children: ReactNode;
...
export type TcbCustomSquareRenderer =
  | FC<TcbCustomSquareProps>
  | keyof JSX.IntrinsicElements;

export type TcbCustomPieceFnArgs = {
  isDragging: boolean;
  squareWidth: number;
  square?: TcbSquare;
};

export type TcbCustomPieceFn = (args: TcbCustomPieceFnArgs) => ReactElement;

export type TcbCustomPieces = {
  [key in TcbPiece]?: TcbCustomPieceFn;
};

export type TcbCustomSquareStyles = {
  [key in TcbSquare]?: Record<string, string | number>;
};

export type TcbBoardOrientation = 'white' | 'black';

export type TcbDropOffBoardAction = 'snapback' | 'trash';

export type TcbCoords = { x: number; y: number };

export type TcbArrow = [TcbSquare, TcbSquare, string?];

export type TcbChessboardProps = {
  /**
   ...
   * @default white
   */
  boardOrientation?: TcbBoardOrientation;
  /**
   ...
   * @default div
   */
  customSquare?: TcbCustomSquareRenderer;
  /**
   * Custom styles for all squares.
   * @default {}
   */
  customSquareStyles?: TcbCustomSquareStyles;
  /**
   * Action to take when piece is dropped off the board.
   * @default snapback
   */
  dropOffBoardAction?: TcbDropOffBoardAction;
  /**
   * User function that is run when piece is dropped off the board.
   * @default snapback
   */
  onPieceDropOffBoard?: (sourceSquare: TcbSquare, piece: TcbPiece) => void;
  /**
   ...
   * @default () => true
   */
  onSparePieceDrop?: (piece: TcbPiece, targetSquare: TcbSquare) => boolean;
  /**
  ...
  onPromotionPieceSelect?: (
    piece?: TcbPromotionPieceOption,
    promoteFromSquare?: TcbSquare,
    promoteToSquare?: TcbSquare
  ) => boolean;
  /**
   * User function that is run when a square is clicked.
   * @default () => {}
   */
  onSquareClick?: (square: TcbSquare, piece: TcbPiece | undefined) => any;
  /**
   * User function that is run when a square is right clicked.
   * @default () => {}
   */
  onSquareRightClick?: (square: TcbSquare) => any;
  /**
   ...
   * @default start
   */
  position?: string | TcbBoardPosition;
  /**
   * Style of promotion dialog.
   * @default default
   */
  promotionDialogVariant?: TcbPromotionStyle;
  /**
   * The square to promote a piece to.
   * @default null
   */
  promotionToSquare?: TcbSquare | null;
  /**
...
export type TcbChessboardDnDProviderProps = {
  children: ReactNode;
